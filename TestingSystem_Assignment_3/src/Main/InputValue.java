...
public class InputValue {
	...
	public void inValue() {
		...
		acc1.setCreateDate(LocalDate.of(2020, 11, 12));
		acc1.setSalary((float) 5240.5);
		...
		acc2.setCreateDate(LocalDate.of(2020, 12, 12));
		acc2.setSalary((float) 10970.055);

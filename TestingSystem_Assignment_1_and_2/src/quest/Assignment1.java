...
public class Assignment1 {
	...
	public void inValue() {
		...
		q1.setType(tq1);
		q1.setCreator(acc3);
		q1.setCreateDate(LocalDate.of(2021, 01, 02));
		...
		q2.setType(tq1);
		q2.setCreator(acc1);
		q2.setCreateDate(LocalDate.of(2021, 02, 01));
		...
		q3.setType(tq2);
		q3.setCreator(acc2);
		q3.setCreateDate(LocalDate.of(2021, 01, 31));
		...
		e1.setCreator(acc3);
		e1.setCreateDate(LocalDate.of(2021, 02, 01));
		...
		e2.setCreator(acc3);
		e2.setCreateDate(LocalDate.of(2021, 02, 02));
		...
		e3.setCreator(acc3);
		e3.setCreateDate(LocalDate.of(2021, 02, 03));
